...
$query_subject = "SELECT course.CourseCode, course.CourseId from course
INNER JOIN faculty_subject WHERE faculty_subject.CourseId = course.CourseId AND faculty_subject.FacId = $suid  ORDER BY course.CourseCode";
...
echo "<br><strong>course<strong> <br> ";
